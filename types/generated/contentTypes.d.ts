...
export interface ApiVehiculoVehiculo extends Schema.CollectionType {
  ...
  attributes: {
    ...
    categoria: Attribute.Enumeration<['Electricos', 'SUVs', 'Autos']>;
    url: Attribute.UID<'api::vehiculo.vehiculo', 'nombre'>;
    avatar: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    imagenes: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    year: Attribute.String;
    modelo: Attribute.String;
    transmision: Attribute.String;
    colorExterior: Attribute.String;
    colorInteriores: Attribute.String;
    equipoAdicional: Attribute.Text;
    aceleracion: Attribute.Decimal;
